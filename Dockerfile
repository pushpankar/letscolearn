...
CMD MIX_ENV=prod SECRET_KEY_BASE="dM+CJlpQ3IHJ49WRZ4qIbl5ZqaDAxDEOsAEjy+a78x8LpeS14X3X0FkLUFh+zNLS" \
                 DATABASE_URL=postgresql://postgres:postgres@docker.for.mac.host.internal/letscolearn_dev \
                 GUARDIAN_SECRET_KEY="NlSF3WMrpWdg+4bxDyW61S8Qq13mVVH9Iq/GsUzEIPUrwlOtIkpgpF1xWAjhBJSP" \
                 mix ecto.migrate && \
    MIX_ENV=prod SECRET_KEY_BASE="dM+CJlpQ3IHJ49WRZ4qIbl5ZqaDAxDEOsAEjy+a78x8LpeS14X3X0FkLUFh+zNLS" \
                 DATABASE_URL=postgresql://postgres:postgres@docker.for.mac.host.internal/letscolearn_dev \
                 GUARDIAN_SECRET_KEY="NlSF3WMrpWdg+4bxDyW61S8Qq13mVVH9Iq/GsUzEIPUrwlOtIkpgpF1xWAjhBJSP" \
